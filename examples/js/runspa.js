 ...
 * Copyright: (c) 2017 Lanx HCM
 * Homepage: http://www.lanx.com.br
 *
...
(function ($) {
    ...
    var PageSetup = {
        ...
        load: function ($hash, options) {
            ...
            var $mainLoading = (options.loadingClass !== undefined ? $(options.loadingClass) : $mainContent);
            ...
            return $.ajax({
                ...
                success: function (data, textStatus, jqXHR) {
                    ...
                    PageSetup.metaTag(options.metaTag);
        ...
        _js: function (file, options, callback) {
...
// ****************
     ...
     * @returns         void | error
     */
    RunSPA.get = function ($path, options, callback) {
